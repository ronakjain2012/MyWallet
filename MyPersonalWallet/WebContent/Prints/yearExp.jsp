...
<title>Year Income | My Personal Wallet V.1</title>
<style type="text/css">
#prints td {
border: 1px dashed;
}
...
<%
	try {
		Class.forName("com.mysql.jdbc.Driver"); 
	 	...
	 	String tableN =(String) session.getAttribute("name")+"_yearB";
	 	String sql = "SELECT t_date,t_id,method,credit,category,paid_to,t_desc FROM "+tableN+" where credit>0"; 
		PreparedStatement ps = con.prepareStatement(sql);
		ResultSet rs = ps.executeQuery();
	 	out.println("<tr> <th> Date </th><th> ID </th><th> Method </th><th> Credit </th><th> Category </th><th> Creditor </th> <th> Description </th> </tr");
		while(rs.next()) {
